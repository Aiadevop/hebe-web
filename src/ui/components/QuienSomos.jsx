    ...
    return (
        <section id="quiensomos">
            <div className="quiencontainer">
                <div className="quiendivided"  onMouseEnter ={() => setAnimate(!animate)}>
                    <div className="pdiv">
                        <p className="pquien">
                    ...
                    <div className="pdiv">
                        <img className={animate ? "animate__animated animate__backInRight --animate-duration-5" : ''}  src="resources\img\taePatada.png" alt="chicoPatada" />
                    </div>
                </div>
